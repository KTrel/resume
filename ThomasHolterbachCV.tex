...
\sffamily{\textbf{\Huge Thomas Holterbach}} & & \multirow{6}{*}{\fboxpic{\includegraphics[width=3.5cm]{thomas_picture_zoom2.jpg}}} \\[5pt]
\sffamily{\large PhD Student at ETH Z{\"u}rich} & &   \\
&  & \\
&  & \\
& \sffamily{ \sffamily{\Letter~~\small \textcolor{darkgray}{\textit{thomahol@ethz.ch}}}} & \\
& \sffamily{ \sffamily{\Large \ComputerMouse \small~~\textcolor{darkgray}{\textit{thomasholterbach.eu}}}} & \\
& \sffamily{ \sffamily{\small \textcolor{darkgray}{\textit{French, 28 years old}}}} &
...
\begin{tabular*}{7in}{p{0.3cm}p{10cm}p{8cm}}
    & \\
& \sffamily{$\bullet$~~Internet routing, architecture and security} & \sffamily $\bullet$~~Programmable network hardware \\
& \sffamily $\bullet$~~Network traffic measurement and analysis & \sffamily $\bullet$~~Artificial intelligence for networking \\
& \sffamily $\bullet$~~Software-defined networking & \sffamily $\bullet$~~Algorithm design and optimisation \\
\end{tabular*}
...
\item
    ...
    \begin{tabular*}{6.5in}{l@{\cftdotfill{\cftsecdotsep}\extracolsep{\fill}}r}
    		...
    		\sffamily $\bullet$~~Passed the Machine Learning (8 credits) \& Data Mining (4 credits) courses in 2018 & \\
...
\item
    ...
    \begin{tabular*}{6.5in}{l@{\cftdotfill{\cftsecdotsep}\extracolsep{\fill}}r}
    		...
    		\sffamily{Specialized in Networks and Embedded systems} & \\
...
\item
    ...
    \begin{tabular*}{6.5in}{l@{\cftdotfill{\cftsecdotsep}\extracolsep{\fill}}r}
    		...
    		\sffamily $\bullet$~~I studied how accurate are Internet measurement platforms such as RIPE Atlas  & \\
    \end{tabular*}\vspace{-6pt}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\resheading{Workshop papers, posters and demos}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
