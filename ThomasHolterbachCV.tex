...
& \sffamily{ \sffamily{\small \textcolor{darkgray}{\textit{French, 29 years old}}}} &
...
& \sffamily $\bullet$~~Network traffic measurements and analysis & \sffamily $\bullet$~~Artificial intelligence for networking \\
...
\item
    ...
    \begin{tabular*}{6.5in}{l@{\cftdotfill{\cftsecdotsep}\extracolsep{\fill}}r}
    		\sffamily \textbf{PhD Student}, ETH Z{\"u}rich, Switzerland & \sffamily Jan. 2016 -\\
    		% \sffamily \textit{Networked Systems Group} & \\
    		\sffamily Advised by Prof. Laurent Vanbever in the Networked Systems Group & \sffamily now\\
...
\item
    ...
    \begin{tabular*}{6.5in}{l@{\cftdotfill{\cftsecdotsep}\extracolsep{\fill}}r}
    		\sffamily \textbf{Master degree in Computer Science}, University of Strasbourg, France & \sffamily Sept. 2012 - \\
    		\sffamily{Specialized in Networks and Embedded systems} & \sffamily June 2014\\
...
\item
    ...
    \begin{tabular*}{6.5in}{l@{\cftdotfill{\cftsecdotsep}\extracolsep{\fill}}r}
    		\sffamily \textbf{Bachelor degree in Computer Science}, University of Strasbourg, France & \sffamily Sept. 2009 -\\
    		\sffamily Ranked 5'/50. Grade: 13.87/20 & \sffamily June 2012\\
...
\begin{tabular}{p{4cm}p{12.5cm}}
  ...
  Extra & Machine learning, Data Mining, Distributed systems, Hardware programming, Parallel programming, Compilation, Probability and Statistics
...
\begin{tabular*}{6.5in}{l@{\cftdotfill{\cftsecdotsep}\extracolsep{\fill}}r}
		\textbf{[5] (Self) Driving Under the Influence: Intoxicating Adversarial Network Inputs}, in HotNets 2019 & \\
...
\begin{tabular*}{6.5in}{l@{\cftdotfill{\cftsecdotsep}\extracolsep{\fill}}r}
		\textbf{[6] Boosting the BGP convergence in SDXes with SWIFT}, in SIGCOMM 2017 & \\
...
\begin{tabular*}{6.5in}{l@{\cftdotfill{\cftsecdotsep}\extracolsep{\fill}}r}
		\textbf{[7] Measurement Vantage Point Selection Using A Similarity Metric} in IRTF \& ISOC ANRW & \\
...
\begin{tabular*}{6.5in}{l@{\cftdotfill{\cftsecdotsep}\extracolsep{\fill}}r}
		\textbf{[8] Supercharge me: Boost Router Convergence with SDN}, in SIGCOMM 2015 & \\
...
\item
\begin{tabular*}{6.5in}{l@{\cftdotfill{\cftsecdotsep}\extracolsep{\fill}}r}
		Communication Networks & 2016 - 2020\\
...
\begin{tabular*}{6.5in}{l@{\cftdotfill{\cftsecdotsep}\extracolsep{\fill}}r}
		\textbf{Occasional Reviewer} for IEEE/ACM ToN and ACM CCR & 2016 and 2017 \\
\end{tabular*}\vspace{-10pt}
