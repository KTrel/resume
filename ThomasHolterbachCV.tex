...
\item
    ...
    \begin{tabular*}{6.5in}{l@{\cftdotfill{\cftsecdotsep}\extracolsep{\fill}}r}
    		...
    		% \sffamily \textit{Networked Systems Group} & \\
    		\sffamily Advised by Prof. Cristel Pelsser in the Computer Networks Group & \sffamily May 2026\\
			\sffamily $\bullet$~~I developed a new BGP data collection and monitoring platform. & \\
			\sffamily The system runs at \href{https://bgproutes.io}{\textit{bgproutes.io}}. & \\
...
\item
\begin{tabular*}{6.5in}{l@{\cftdotfill{\cftsecdotsep}\extracolsep{\fill}}r}
		14 Semester thesis supervision (12 at ETH Zurich, 2 at the University of Strasbourg)\\
		% ETH Z{\"u}rich, with Prof. Laurent Vanbever &\\
\end{tabular*}\vspace{-6pt}
