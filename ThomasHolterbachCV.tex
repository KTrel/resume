...
& \sffamily{ \sffamily{\small \textcolor{darkgray}{\textit{French, 31 years old}}}} &
...
\item
    ...
    \begin{tabular*}{6.5in}{l@{\cftdotfill{\cftsecdotsep}\extracolsep{\fill}}r}
			...
			\sffamily $\bullet$~~I research how to quickly detect and mitigate BGP leaks and hijacks.  & \\
			\sffamily $\bullet$~~I study which BGP vantage points to use when measuring Internet routing.  & \\
